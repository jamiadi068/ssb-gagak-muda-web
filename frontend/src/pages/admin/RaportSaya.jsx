  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // 1. AMBIL DATA PEMAIN
        // ==================================================
        const pemainResponse = await api.get(`/pemain/${pemainId}`);

        console.log("Data pemain:", pemainResponse.data);
        ...
        console.log("Data raport:", raportResponse.data);
        ...
        if (
          ...
          setRaport(null);
          setError("Raport belum tersedia.");
          return;
        }
      ...
      <div className="min-h-screen bg-slate-100 p-5 flex items-center justify-center">
        ...
        <div className="max-w-md w-full bg-white rounded-xl p-6 shadow-sm border border-slate-300 text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">
            {error || "Belum ada rapor dari pelatih."}
          </p>
